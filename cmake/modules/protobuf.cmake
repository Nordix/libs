...
elseif(NOT USE_BUNDLED_PROTOBUF)
	...
	if(NOT TARGET protobuf)
		if(NOT WIN32)
			set(PROTOBUF_LIB_PATTERN "libprotobuf*")
			ExternalProject_Add(
				protobuf
			...
			set(PROTOBUF_LIB "${PROTOBUF_INSTALL_DIR}/lib/libprotobuf.lib")
			set(PROTOBUF_LIB_PATTERN "*.lib")
		...
		install(
			DIRECTORY ${PROTOBUF_INSTALL_DIR}/lib/
			DESTINATION "${CMAKE_INSTALL_LIBDIR}/${LIBS_PACKAGE_NAME}"
			COMPONENT "libs-deps"
			FILES_MATCHING
			PATTERN ${PROTOBUF_LIB_PATTERN}
		)
		install(
			DIRECTORY "${PROTOBUF_INSTALL_DIR}/include/"
